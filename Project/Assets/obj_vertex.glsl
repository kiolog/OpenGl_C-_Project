...
vec3 position[5] = 
{
	vec3(-176.0f, 0.0f, -42.0f),
	vec3(-176.0f, 0.0f, -105.0f),
	vec3(-129.0f, 0.0f, -147.0f),
	vec3(-86.0f, 0.0f, -105.0f),
	vec3(-86.0f, 0.0f, -42.0f),
};
...
void main()
{
    ...
    gl_Position = um4p * um4v * move * rot * um4m * vec4(iv3vertex, 1.0);
